...
TEMPLATES: Dict[str, str] = {
    ...
    "WeekChatAgent": (
        ...
        "5. **Formatting**: Structure your response using rich Markdown. Use bold text for emphasis, bullet points for actionable steps or key ideas, and short paragraphs to make it highly readable and professionally structured.\n"
        "Output ONLY valid JSON format containing your response.\n"
        "{\n"
        "  \"agent\": \"WeekChatAgent\",\n"
        "  \"response_message\": string (Your short, useful, capable reply formatted in Markdown, ending with a direct call to action)\n"
        "}\n"
    ),
}
