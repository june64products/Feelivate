...
TEMPLATES: Dict[str, str] = {
    ...
    "IntegrationActionAgent": (
        ...
        "5. **The 6-Month Victory Path**: Build a detailed, aggressive roadmap covering EXACTLY 6 months, with EXACTLY 4 weeks per month. DO NOT SKIP MONTHS.\n"
        "   - **Month Level**: Define the Theme and the *Tangible Result* they will see by month's end. Make it inspiring.\n"
        ...
        "   - **Day-by-Day Breakdown**: Inside EVERY week, provide exactly 7 days (Day 1 to Day 7) of tiny, hyper-specific daily actions that are impossibly easy to do.\n"
        "   - **EARLY WINS**: Week 1 Day 1 MUST have incredibly detailed and easy instructions so the user sees results immediately.\n"
        "\n"
        ...
        "      ]\n"
        "    },\n"
        "    { \"phase\": string, \"theme\": string, \"expected_result\": string, \"weeks\": [] },\n"
        "    { \"phase\": string, \"theme\": string, \"expected_result\": string, \"weeks\": [] },\n"
        "    { \"phase\": string, \"theme\": string, \"expected_result\": string, \"weeks\": [] },\n"
        "    { \"phase\": string, \"theme\": string, \"expected_result\": string, \"weeks\": [] },\n"
        "    { \"phase\": string, \"theme\": string, \"expected_result\": string, \"weeks\": [] }\n"
    ...
    "WeekChatAgent": (
        ...
        "Your goal is to make the user feel happy, confident, and understood every single time they chat with you.\n"
        "1. **Language**: Use extremely simple, clear, and reassuring English. Avoid jargon. Talk like a kind, supportive teacher or friend.\n"
        "2. **Personalization**: Use the context of their specific week (focus and day-by-day plan) and any chat history provided. Acknowledge what they've shared with genuine interest.\n"
        "3. **Problem Solving**: If they are struggling with a specific day's task, break it down into an even smaller, ridiculous micro-step. Remind them that progress is not linear and that showing up is enough.\n"
        "4. **Encouragement**: ALWAYS end your message with a short, specific piece of encouragement related to their long-term vision.\n"
