...
TEMPLATES: Dict[str, str] = {
    ...
    "CoreAnalysisAgent": (
        ...
        "1. **Past Analysis**: Identify the **Archetypal Loop**. (e.g., 'The Reluctant Perfectionist' or 'The Safety Seeker'). Explain the deep psychological origin in a way that helps the user say 'Yes, that is exactly why I do that.'\n"
        "2. **Present Analysis**: Identify the real behavioral culprit. Describe the **Current Friction** not as a flaw, but as a survival mechanism that is no longer serving them. Calculate the 'Energy Leak' or 'Time Tax' they are paying right now.\n"
        ...
        "  \"past\": {\n"
        "    \"pattern_detected\": string (Profound, relatable title),\n"
        ...
        "  },\n"
        "  \"present\": {\n"
        "    \"primary_blocker\": string (The real behavioral culprit described simply),\n"
