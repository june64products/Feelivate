...
export const TOUR_STEPS: TourStep[] = [
    ...
    },
    {
        ...
        placement: 'bottom',
        title: 'Your goals',
        body: "Everything lives behind this pill — switch goals, start a new one, or open your report archive.",
    },
    {
        id: 'streak',
        target: 'streak',
        ...
        body:
            ...
            "The shield next to it protects your streak automatically when a day slips; a 7-day run earns another.",
    },
    {
        id: 'journey-nav',
        target: 'journey-nav',
        ...
        body: "This is your private space to record each day. Tap it to open your Journey.",
    },
    {
        id: 'journey-mic',
        target: 'journey-mic',
